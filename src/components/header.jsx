    ...
    <header>
      ...
      <div className='nav-container'>
        ...
        <div className='dropdown-menu js-dropdown-menu'>
          <Link to='/cassandra-cunningham-portfolio/about' className='menu-about' onClick={menuItemSelected}><p>About</p></Link>
          <Link to='/cassandra-cunningham-portfolio/projects' className='menu-projects' onClick={menuItemSelected}><p>Projects</p></Link>
